...
echo ""
echo "👉 접속 주소: http://localhost:8005/main.html"
echo "👉 어드민 접속: http://localhost:8005/admin.html"
echo "========================================================================"
echo ""

# Run Python3 built-in HTTP server serving the frontend directory on port 8005
# 스크립트 파일이 위치한 실제 디렉토리를 동적으로 획득
