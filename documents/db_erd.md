...
> [!NOTE]
> **성능 최적화 및 데드락 예방을 위한 물리 FK 제거**:
> 고속 트랜잭션 처리와 데드락 최소화를 위해 데이터베이스 수준의 물리적 외래키(FK) 제약조건은 제거하고, 테이블 간의 관계는 애플리케이션 및 논리적 레이어에서만 보장하도록 설계되었습니다.
> 상세한 논리적 엔티티 관계 구조는 [schema.dbml](file:///d:/exchange_be/documents/schema.dbml) 파일에서도 확인할 수 있습니다. (이 파일을 [dbdiagram.io](https://dbdiagram.io/) 등 도구에 입력하여 대화형 ERD를 그릴 수 있습니다.)

---

## 📊 1. Mermaid ERD 다이어그램

아래 다이어그램은 테이블 간의 논리적 관계(1:N, 1:1) 매핑을 나타냅니다.
