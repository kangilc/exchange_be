...
public final class AdapterKafkaRunner {
    public static void main(String[] args) {
        // 환경 변수 또는 설정 파일에서 Kafka 브로커 정보 및 매칭 엔진 호스트/포트 정보를 조회합니다.
        ...
        // Kafka 프로듀서 설정을 생성하고 아웃박스 객체를 초기화합니다.
        ...
        while (true) {
            try (Socket socket = new Socket(engineHost, enginePort);
                ...
                try {
                    ...
                    // 쓰레드 인터럽트 발생 시 루프를 종료하고 정중히 쓰레드를 종료
        ...
        // 아웃박스 자원(Kafka Producer)을 안전하게 종료합니다.
        outbox.close();
    }
}
